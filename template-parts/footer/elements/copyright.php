...
if ( !defined('NEWSX_CORE_PRO_VERSION') || !newsx_core_pro_fs()->can_use_premium_code() ) {
	...
	$powered_by = sprintf( ' | ' . esc_html__( 'Powered by %s', 'news-magazine-x' ), '<a href="' . esc_url( 'https://ercoliconsulting.eu' ) . '" rel="nofollow noopener" target="_blank">Ercoli Consulting S.r.l.</a>' );
